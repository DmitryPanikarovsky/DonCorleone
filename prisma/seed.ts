...
const generatedData = async () => {
    ...
    await prisma.productItem.createMany({
        data: [
            ...
            generateProductItem({ productId: pizza1.id, pizzaType: 1, pizzaSize: 20 }),
            generateProductItem({ productId: pizza1.id, pizzaType: 2, pizzaSize: 30 }),
            generateProductItem({ productId: pizza1.id, pizzaType: 2, pizzaSize: 40 }),

            // Пицца "Сырная"
            generateProductItem({ productId: pizza2.id, pizzaType: 1, pizzaSize: 20 }),
            generateProductItem({ productId: pizza2.id, pizzaType: 1, pizzaSize: 30 }),
            generateProductItem({ productId: pizza2.id, pizzaType: 1, pizzaSize: 40 }),
            generateProductItem({ productId: pizza2.id, pizzaType: 2, pizzaSize: 20 }),
            generateProductItem({ productId: pizza2.id, pizzaType: 2, pizzaSize: 30 }),
            generateProductItem({ productId: pizza2.id, pizzaType: 2, pizzaSize: 40 }),

            // Пицца "Чоризо фреш"
            generateProductItem({ productId: pizza3.id, pizzaType: 1, pizzaSize: 20 }),
            generateProductItem({ productId: pizza3.id, pizzaType: 2, pizzaSize: 30 }),
            generateProductItem({ productId: pizza3.id, pizzaType: 2, pizzaSize: 40 }),
